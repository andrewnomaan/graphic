        ...
        <section class="section" id="photo-editor">
            ...
            <div class="row">
                <div class="card p-4">
                    ...
                    ?>
                <div class="card">
                <a href="action.php?bulk=1" class="btn btn-danger my-4" onclick="return confirm('Are you sure to delete all')">Bulk Delete</a>
                   ...
                   ?>
                            <div class="col-md-4 my-4 text-center">
                                <div class="card align-items-center p-3">
                                    ...
                                    <a href="action.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete')">Delete</a>
                                </div>
                            </div>
                            <?php
                        }
